...
values
  ('yahmurim-trail', 'שביל היחמורים',
   ...
   'reserves', 'easy', 'north', 32.7571474, 35.0201328, 'כשעה', 1, 340, true, false, false, false, 'free',
  ...
  ('nahal-avuv', 'נחל אבוב',
   ...
   'water', 'hard', 'deadsea', 31.2321212, 35.2380755, '3 שעות', 3, 180, false, false, false, true, 'free',
