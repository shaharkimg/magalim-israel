...
values
  ('ein-rihaniya', 'עין ריחניה (מפל ריחניה)',
   ...
   'water', 'medium', 'north', 32.6207674, 35.0909932, 'שעה', 1.5, 40, true, false, false, true, 'free',
   null, 1, null),

  ('maayan-haulmosim', 'מעיין האולמוסים',
   'מעיין ברמת השופט, עם בריכת-מים טבעית מוקפת סלעים - יעד רחצה מוכר ברמות מנשה.',
   'water', 'easy', 'north', 32.6147726, 35.0930927, 'שעה', 1, 94, true, false, false, true, 'free',
   null, 1, null),

  ('ein-nili', 'עין נילי',
   'מעיין זורם ברמות מנשה, עם בריכת-מים נעימה לרחצה בעונה החמה - יעד פופולרי יחסית באזור.',
   'water', 'easy', 'north', 32.5541667, 35.0494444, 'שעה', 1, 161, true, false, false, true, 'free',
   null, 1, null)
