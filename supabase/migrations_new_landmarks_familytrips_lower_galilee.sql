...
values
  ('ein-yivka', 'עין יבקע (מעיין הסוסים)',
   ...
   'water', 'easy', 'north', 32.756441, 35.174689, 'שעה', 1,
   10, 730, true, false, false, true, 'free',
   null, 1, null),

  ('ein-netofa', 'עין נטופה',
   'מעיין נובע מול נוף פתוח של בקעת בית נטופה בגליל התחתון - יעד שקט ופחות מוכר.',
   'water', 'medium', 'north', 32.8391667, 35.3744444, 'שעה', 1.5,
   10, 6, true, false, false, true, 'free',
   null, 1, null),

  ('einot-tzipori', 'עינות ציפורי',
   'מעיין צלול ומרענן באזור נצרת, עם שרידים עתיקים בסביבה - יעד קליל לביקור קצר.',
   'water', 'easy', 'north', 32.733722, 35.276754, 'כחצי שעה', 0.5,
