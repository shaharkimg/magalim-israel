...
values
  ('ein-matta', 'עין מטע',
   ...
   'water', 'easy', 'jerusalem', 31.7155556, 35.05, 'כחצי שעה', 0.5,
   10, 46, true, false, false, true, 'free',
   null, 0.5, null),

  ('ein-tanur-jerusalem', 'עין תנור (הרי ירושלים)',
   'מעיין קטן וצנוע בהרי ירושלים, סמוך לעין מטע - נקודת-מים שקטה ופחות מוכרת לתיירים.',
   'water', 'easy', 'jerusalem', 31.714677, 35.048391, 'כחצי שעה', 0.5,
   10, 32, true, false, false, true, 'free',
   null, 0.5, null),
  ...
  ('ein-hamesayaat', 'עין המסייעת (המעיין המסתובב)',
   ...
   'water', 'medium', 'jerusalem', 31.8015927, 35.1318339, 'שעה', 1.5,
   10, 154, false, false, false, true, 'free',
   null, 1, null),

  ('ein-sappir', 'עין ספיר',
   'מעיין הנובע בתוך מערה קטנה בהרי ירושלים - יעד ייחודי וסקרן למטיילים המחפשים חוויה שונה.',
   'water', 'medium', 'jerusalem', 31.7608333, 35.1313889, 'שעה', 1,
   10, 145, false, false, false, true, 'free',
   null, 1, null),

  ('ein-miklaf', 'עין מקלף',
   'מעיין קטן ונגיש ליד מוצא, עם גישה נוחה כמעט עד לבריכת-המים - יעד קליל וקרוב לירושלים.',
   'water', 'easy', 'jerusalem', 31.7941887, 35.1648354, 'כחצי שעה', 0.5,
   10, 10, true, false, false, true, 'free',
   null, 0.5, null),

  ('ein-limor', 'עין לימור',
   'מעיין אינטימי בלב הרי ירושלים, סמוך לכפר עין ראפה, עם גישת-רכב נוחה כמעט עד המים - יעד רומנטי ושקט.',
   'water', 'easy', 'jerusalem', 31.792537, 35.107359, 'כחצי שעה', 0.5,
   10, 120, true, false, false, true, 'free',
   null, 0.5, null),

  ('ein-kesalon', 'עין כסלון',
   'בריכת-מעיין קטנה בנחל כסלון, עם קירות-אבן מסביב - נקודת-עצירה נעימה בדרך בהרי ירושלים.',
   'water', 'easy', 'jerusalem', 31.7780556, 35.0511111, 'כחצי שעה', 0.5,
   10, 62, true, false, false, true, 'free',
   null, 0.5, null)
